...
class Header:
  ...
  def write(self, oprot):
    ...
    if self.parameters != None:
      ...
      for kiter7,viter8 in list(self.parameters.items()):
...
class Authentication:
  ...
  def write(self, oprot):
    ...
    if self.action_id != None:
      ...
      oprot.writeString(self.action_id)
      oprot.writeFieldEnd()
    if self.authentication_type != None:
